...
<form method="post">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="domain" id="projectDomain" placeholder="Domaine principal du projet (facultatif)...">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <label for="projectMaintenance" value="1">
        <input type="checkbox" name="maintenance" id="projectMaintenance">
