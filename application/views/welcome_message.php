...
<table class="table table-hover">
  ...
  <tbody>
    <tr class="searcher-item" data-searcher="init_database">
      ...
      <td><button class="btn btn-primary request-runner" data-request="/cron/init_database" type="button">Éxécuter</button></td>
    </tr>
    <tr class="searcher-item" data-searcher="sellsy_clients">
      ...
      <td><button class="btn btn-primary request-runner" data-request="/cron/sellsy_clients" type="button">Éxécuter</button></td>
    </tr>
    <tr class="searcher-item" data-searcher="sellsy_contacts">
      ...
      <td><button class="btn btn-primary request-runner" data-request="/cron/sellsy_contacts" type="button">Éxécuter</button></td>
    </tr>
    <tr class="searcher-item" data-searcher="sellsy_orders">
      ...
      <td><button class="btn btn-primary request-runner" data-request="/cron/sellsy_orders" type="button">Éxécuter</button></td>
    </tr>
    <tr class="searcher-item" data-searcher="sellsy_invoices">
      ...
      <td><button class="btn btn-primary request-runner" data-request="/cron/sellsy_invoices" type="button">Éxécuter</button></td>
    </tr>
  </tbody>
</table>
